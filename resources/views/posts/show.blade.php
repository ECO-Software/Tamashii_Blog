    ...
    <div class="container py-8">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div class="lg:col-span-2">
                <figure class="py-2">
                    <img src="{{ Storage::url($post->image->url) }}" alt="{{ $post->title }}" class="w-full h-80 object-cover object-center">
                </figure>
                    ...
                    @foreach ($related as $relate_post)
                        <li class="mb-4">
                            <a class="flex" href="{{ route('posts.show', $relate_post) }}">
                                <img class="w-36 h-20 object-cover object-center" src="{{ Storage::url($relate_post->image->url) }}" alt="">
                                <span class="ml-2 my-auto text-gray-600">{{ $relate_post->title }}</span> 
                            </a>
                        </li>
                    @endforeach
                </ul>
